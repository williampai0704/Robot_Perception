...
def evaluate(obj_name, pred_pose, gt_pose):
    """
    Compute average closest point distance of a specific object.
    """
    pred_pts = obj_mesh2pts(obj_name, point_num=1000, transform=pred_pose)
    gt_pts = obj_mesh2pts(obj_name, point_num=1000, transform=gt_pose)
